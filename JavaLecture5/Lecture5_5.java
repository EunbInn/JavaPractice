...
public class Lecture5_5 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("====================================\n");
		System.out.printf("%s%10s%4s%7s\n", blank(itemname1, 31), k08_df.format(price1) + "", amount1 + "", k08_df.format(price1 * amount1) + "");
		System.out.printf("[%s]\n", itemcode1);
		System.out.printf("%s%10s%4s%7s\n", blank(itemname2, 29), k08_df.format(price2) + "", amount2 + "", k08_df.format(price2 * amount2) + "");
		System.out.printf("[%s]\n", itemcode2);
		System.out.printf("%s%10s%4s%7s\n", blank(itemname3, 31), k08_df.format(price3) + "", amount3 + "", k08_df.format(price3 * amount3) + "");
		System.out.printf("[%s]\n", itemcode3);
		System.out.printf("=====================================\n");
		System.out.printf("%s%16s\n",blank2("과세합계",8), k08_df.format(originPrice));
		System.out.printf("%s%15s\n", blank2("부가세",6), k08_df.format(taxPrice));
		System.out.printf("-------------------------------------\n");
		System.out.printf("판매합계%20s\n", k08_df.format(sumPrice));
		System.out.printf("=====================================\n");
		System.out.printf("-------------------------------------\n");
		System.out.printf("=====================================\n");
